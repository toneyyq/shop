		...
		<div class="container">
			<div class="row" >
				<div class="page-header">
				  	<h1 class="col-md-8" style="font-family: '楷体';">缘起  后台管理系统 <small>&ensp;&ensp;公告管理  修改公告</small></h1>
			...
			<div class="row" id="content">
				<div class="row" id="c-head">
					<div class="col-md-6">
						<div class="page-header">
						  	<h2 style="font-family: '楷体';">修改公告信息<span class="glyphicon glyphicon-plus"></span></h2> 
						</div>
					</div>
					<div class="col-md-6">
						<nav aria-label="...">
				...
				<div class="row" id="c-content">
					<form action="${pageContext.request.contextPath}/updateplacard.action" class="form-horizontal" method="post">
						<div class="form-group col-md-12 ">
						    <label for="placard_tittle" class="col-md-2 control-label">公告标题:</label>
						    <div class="col-md-9">
						    	<input type="hidden" name="placardID" value="${placard.placardID}">
						    	<input type="text" class="form-control " name="placardTitle" id="placard_tittle" value="${placard.placardTitle}" />
						    </div>
						</div>
						<div class="form-group col-md-12 ">
						    <label for="placard_content" class="col-md-2 control-label">公告内容:</label>
						    <div class="col-md-9">
						    	<textarea name="placardContent" class="form-group-lg form-control" style="height: 180px;" >${placard.placardContent}</textarea>
						    </div>
						</div>
						<div class="form-group col-md-12 form-inline">
						    <label for="placard_stime" class="col-md-2 control-label">发布时间:</label>
						    <div class="col-md-3">
					    	<input type="text" name="issueDate" id="sDate" class="laydate-icon col-md-12 form-group-lg form-control" value="<fmt:formatDate value="${placard.issueDate}" type="date" />" />
					    	</div>
						    <label for="placard_etime" class="col-md-2 control-label">失效时间:</label>
						    <div class="col-md-3">
					    	<input type="text" name="expireDate" id="eDate" class="col-md-12 form-group-lg form-control" value="<fmt:formatDate value="${placard.expireDate}" type="date" />" />
							</div>
						</div>
						<div class="form-group col-md-12">
