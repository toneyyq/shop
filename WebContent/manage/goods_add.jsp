...
<html>
	...
	<body>
		<div class="container">
			<div class="row" >
				<div class="page-header">
				  	<h1 class="col-md-8" style="font-family: '楷体';">缘起  后台管理系统 <small>&ensp;&ensp;商品管理  商品添加</small></h1>
			...
			<div class="row" id="content">
				<div class="row" id="c-head">
					<div class="col-md-6">
						<div class="page-header">
						  	<h2 style="font-family: '楷体';">商品添加<span class="glyphicon glyphicon-plus"></span></h2> 
						</div>
					</div>
					<div class="col-md-6">
						<nav aria-label="...">
				...
				<div class="row" id="c-content">
					<form action="${pageContext.request.contextPath}/addGoods.action" class="form-horizontal" method="post"	enctype="multipart/form-data">
						<div class="form-group col-md-12 ">
						    <label for="good_name" class="col-md-3 control-label">商品名称</label>
						    <div class="col-md-9">
						    	
						    	<input type="text" class="form-control" name="goodsName" id="good_name" value="" />
						    </div>
						</div>
						<div class="form-group col-md-12 ">
						    <label for="good_img" class="col-md-3 control-label">商品图片</label>
						    <div class="col-md-9">
						    	<input type="file" id="goodPic" name="goodPic"   />
						    	<!-- js图片显示 -->
						    	<br />
						    	<img alt="" src="" id="goodspic" width="150px" height="150px">
						    </div>
						</div>
						<div class="form-group col-md-12 ">
						    <label for="good_info" class="col-md-3 control-label">商品简介</label>
						    <div class="col-md-9">
						    	<textarea name="goodsIntroduce" id="goodsIntroduce" class="form-control" ></textarea>
						    </div>
						</div>
						...
						<div class="form-group col-md-6">
						    ...
						    <div class="col-md-6 ">
						    	<input type="text" class="form-control" id="goodsNormalPrice" name="goodsNormalPrice" value="" placeholder="￥" />
						    </div>
						</div>
						<div class="form-group col-md-6">
						    <label for="good2_price" class="col-md-6 control-label ">商城价格</label>
						    <div class="col-md-6 ">
						    	<input type="text" class="form-control" id="goodsMemberPrice" name="goodsMemberPrice" placeholder="￥" />
						    </div>
						</div>
						<div class="form-group col-md-6">
						    <label for="discount" class="col-md-6 control-label ">商品数量</label>
						    <div class="col-md-6 ">
						    	<input type="text" class="form-control" id="goodsNumber" name="goodsNumber" value=""/>
						    </div>
						</div>
						<div class="form-group col-md-6">
						...
						<div class="form-group col-md-12">
								<input type="submit" class="btn btn-success col-md-3 col-md-offset-3" value="保存" />
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/manage/goods_add.js"></script>
	</body>
</html>
